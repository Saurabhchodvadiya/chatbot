...
from llama_index.core import SimpleDirectoryReader, ServiceContext, VectorStoreIndex, GPTListIndex, LLMPredictor, PromptHelper
# from openai 
import pandas
import openai
import numpy as np
...
openai.api_key = 'sk-proj-Ng6RQQY78yRlutrkP6YnT3BlbkFJ2jFHrWMayruEjgQCAtcO'

...
import os
import time
# from openai import get_embedding, cosine_similarity
import pandas
import openai
import numpy as np
import glob
...
def logic(question):
    ...
    # print(df.columns)
    # embs = []
    # for r1 in range(len(df.combined)): # Changing the format of the embeddings into a list due to a parsing error
    #     e1 = df.combined[r1].split(",")
    #     print(len(e1))
...
@app.route("/")
def home():
    return render_template(r"new_bot.html") # Renders the webpage
